...
module.exports=controller_Admin = {
    ...
    // Gestion Etudiants, Professeur , Filieres et Matieres
    studentManage: async (req, res) => {
    ...
    sectorManage: async (req, res) =>{
        db.Filiere.findAll().then(sectors =>{
            res.render('./sectorManage.ejs', {sectors});
        }).catch(error =>{
            res.send('error!!');
        })
    },

    subjectManage: async (req, res) =>{
